...
def output_data(allPrices, n_steps, n_simulations):
    ...
    #plt.show()
    plt.savefig('ProbDistPer_S='+str(n_steps)+'_N='+str(n_simulations),bbox_inches='tight')
    ...
    with open('ProbPer_Price=1000_S='+str(n_steps)+'_N='+str(n_simulations)+'.txt', 'w') as myFile:
